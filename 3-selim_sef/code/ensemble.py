...
if __name__ == '__main__':
    ...
    arg('--ensembling_cpu_threads', type=int, default=24)
    arg('--ensembling_dir', type=str, default='../test_results/ensemble')
    arg('--strategy', type=str, default='average')
    arg('--folds_dir', type=str, default='../test_results/folds')
