...
from training.losses import dice_round, EuclideanDistance, soft_dice_loss
...
def main():
    ...
    arg('--prefix', type=str, default='instance_')
    ...
    arg("--opt-level", default='O2', type=str)
    ...
    for epoch in range(start_epoch, conf['optimizer']['schedule']['epochs']):
        ...
        if epoch % args.test_every == 0:
            ...
            dice_best = evaluate_val(args, val_data_loader, dice_best,
                                     model,
