...
if __name__ == '__main__':
    ...
    best_snapshot_name = 'eff6_4k_{0}_best_tuned_0'.format(fold)
    last_snapshot_name = 'eff6_4k_{0}_last_tuned_0'.format(fold)

    np.random.seed(12341 + fold*10)
    random.seed(12341 + fold*10)
    ...
    data_train = TrainDataset(train_files, train_dir, masks_dir, crop_size=928, scale=4, tune=True)
    ...
    scheduler = lr_scheduler.MultiStepLR(optimizer, milestones=[10, 20, 30, 40, 50, 60], gamma=0.5)
