...
if __name__ == '__main__':
    ...
    best_snapshot_name = 'eff7_4k_{0}_best_full2_0'.format(fold)
    last_snapshot_name = 'eff7_4k_{0}_last_full2_0'.format(fold)

    np.random.seed(123 + fold)
    random.seed(123 + fold)
    ...
    data_train = TrainDataset(train_files, train_dir, masks_dir, crop_size=864, scale=4)
